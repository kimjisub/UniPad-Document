...
| ------ | --- | --- |
| [info](./info) | 📄file | UniPack explanation and arguments |
| [sounds](./sounds) | 📁folder | the folder holding sound file |
| [keySound](./keySound) | 📄file | maps the sound file to the button |
| [keyLED](./keyLED) | 📁folder | the LED folder holding event files |
| [autoPlay](./autoPlay) | 📄file | saves voice record to automatically press the button |
