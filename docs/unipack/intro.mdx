...
| ------ | --- | --- |
| [info](info.md) | 📄file | UniPack explanation and arguments |
| [sounds](sounds.md) | 📁folder | the folder holding sound file |
| [keySound](keySound.md) | 📄file | maps the sound file to the button |
| [keyLED](keyLED.md) | 📁folder | the LED folder holding event files |
| [autoPlay](autoPlay.md) | 📄file | saves voice record to automatically press the button |
